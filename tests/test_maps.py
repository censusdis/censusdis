...
class ShapeReaderTestCase(unittest.TestCase):
    ...
    def test_url_for_file_09(self):
        ...
        self.assertEqual('https://www2.census.gov/geo/tiger/GENZ2009/shp/cb_something.zip', url)

        url = self.reader09._url_for_file('tl_something')
        self.assertEqual('https://www2.census.gov/geo/tiger/TIGER2009/SOMETHI/2009/tl_something.zip', url)

    def test_url_for_file_20(self):
        url = self.reader20._url_for_file('cb_something')
        self.assertEqual("https://www2.census.gov/geo/tiger/GENZ2020/shp/cb_something.zip", url)

        url = self.reader20._url_for_file('tl_something')
        self.assertEqual("https://www2.census.gov/geo/tiger/TIGER2020/SOMETHING/tl_something.zip", url)
