...
class CensusApiVariableSourceTestCase(unittest.TestCase):
    ...
    def test_url(self):
        ...
        self.assertEqual(
            "https://api.census.gov/data/2020/acs/acs5/variables/B01001_001E.json",
            url
        )
    ...
    def test_group_url(self):
        ...
        self.assertEqual(
            "https://api.census.gov/data/2020/acs/acs5/variables.json",
            url
        )

        url = self._variable_source.group_url(self._dataset, self._year, self._group_name)

        self.assertEqual(
            "https://api.census.gov/data/2020/acs/acs5/groups/B01001.json",
            url
        )
